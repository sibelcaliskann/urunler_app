...
class _AnasayfaState extends State<Anasayfa> {
  Future<List<Urunler>> urunleriYukle() async{
    ...
    var u1=Urunler(id: 1, ad: "Macbook Pro 14", resim: "bilgisayar.png", fiyat: 430000);
    var u2= Urunler(id: 2, ad: "Rayban Club Master", resim: "gozluk.png", fiyat: 2500);
    var u3=Urunler(id: 3, ad: "Sony ZX Series", resim: "kulaklik.png", fiyat: 400000);
    var u4=Urunler(id: 4, ad: "Gio Armani", resim: "parfum.png", fiyat: 2000);
    var u5=Urunler(id: 5, ad: "Casio X Series", resim: "saat.png", fiyat: 18000);
    var u6=Urunler(id: 6, ad: "Dyson V8", resim: "supurge.png", fiyat: 19000);
    var u7=Urunler(id: 7, ad: "IPhone 13", resim: "telefon.png", fiyat: 320000);
                    ...
                    child: Row(
                      children: [
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(urun.ad),
                            const SizedBox(height: 10,), //sabit  bir bosluk eklendi
